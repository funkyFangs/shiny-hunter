<script lang="ts">
	...
	function getHuntingMethods(generation?: Generation, versionGroup?: VersionGroup, version?: Version): HuntingMethod[] | undefined {
	...
	$: if (huntingMethods && selectedHuntingMethod && !huntingMethods.includes(selectedHuntingMethod)) {
