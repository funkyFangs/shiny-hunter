<script lang="ts">
	...
	function getOdds(rarity: 0 | 1 | 2 | 3 | undefined, distance: number | undefined): number | undefined {
		if (rarity === undefined
			|| distance === undefined
...
<div id="counter">
	<table>
		...
		<tr>
			...
			<td>
				{#if odds !== undefined}
					<Fraction id="odds" numerator={odds} denominator={100} showFraction={false} accuracy={0}/>
				{:else}
					<span>-</span>
				{/if}
			</td>
...
<style>
  ...
  #count:focus, #distance, #furthest-distance, select {
