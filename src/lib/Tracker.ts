...
export const selectedTrackerIndex = localWritable<number | undefined>(
  "tracker",
  undefined,
);
export const selectedTracker = derived(
  [trackers, selectedTrackerIndex],
  ([trackers, selectedIndex]) =>
    selectedIndex !== undefined ? trackers[selectedIndex] : undefined,
  undefined,
);
